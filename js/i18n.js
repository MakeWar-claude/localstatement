...
const LS_I18N = (() => {
  const D = {
    es: {
      ...
      priceSoon: 'Muy pronto', priceNote: 'El pago se activa en los próximos días (vía Paddle). Hasta entonces, todo es gratis sin límite.',
    ...
    en: {
      ...
      priceSoon: 'Coming soon', priceNote: 'Payments go live in the next few days (via Paddle). Until then, everything is free and unlimited.',
      faqTitle: 'FAQ',
    ...
    it: {
      ...
      priceSoon: 'In arrivo', priceNote: 'I pagamenti si attivano nei prossimi giorni (via Paddle). Fino ad allora, tutto è gratuito e illimitato.',
    ...
    de: {
      ...
      priceSoon: 'Bald verfügbar', priceNote: 'Zahlungen werden in den nächsten Tagen aktiviert (über Paddle). Bis dahin ist alles kostenlos und unbegrenzt.',
